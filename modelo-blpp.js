...
// archivos:  js, json, txt, html, svg, css, ttf, woff, base64, blob, wasm.    <
...
/* [0] METADATOS */
{
	...
	fromato_w: "web", // modos de representacion (texto, canvas, prompt, gui, etc)
...
/* [-1] HASH-256 */
"string 64 chars", // origen = (persona + "_" + UUID)
],
...
Para publicar un paquete:
	...
	(hash anterior + "_" + json de paquete actual) sin contar -1.
	4. cada hash se agrega al final de cada lista (posicion -1)
...
Para edicion interna de un paquete (enlaces azules):
	...
	y pasan a formar (tardiamente) parte oficial del paquete.
...
Para edicion externa de un paquete (enlaces rojos):
	...
	3. a partir del hash de la divergencia se genera nuevo hash.
